...
Q_CONSTINIT static const qt_meta_stringdata_CLASSReceiverENDCLASS_t qt_meta_stringdata_CLASSReceiverENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(9, 16),  // "requestProcessed"
        QT_MOC_LITERAL(26, 0),  // ""
        QT_MOC_LITERAL(27, 12),  // "responseData"
        QT_MOC_LITERAL(40, 14),  // "processRequest"
        QT_MOC_LITERAL(55, 7)   // "request"
    },
    "Receiver",
    "requestProcessed",
    "",
...
void Receiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->requestProcessed((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1]))); break;
        case 1: _t->processRequest((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Receiver::*)(const QByteArray & );
            if (_t _q_method = &Receiver::requestProcessed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Receiver::requestProcessed(const QByteArray & _t1)
{
